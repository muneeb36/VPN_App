...
class TinyDB(appContext: Context) {
    ...
    fun getListInt(key: String?): ArrayList<Int?> {
        ...
        val arrayToList = ArrayList<String>(Arrays.asList<String?>(*myList))
    ...
    fun putListInt(key: String, intList: ArrayList<Int?>) {
        checkForNullKey(key)
        val myIntList = intList.toTypedArray<Int?>()
    ...
    fun putListLong(key: String, longList: ArrayList<Long?>) {
        checkForNullKey(key)
        val myLongList = longList.toTypedArray<Long?>()
    ...
    fun putListDouble(key: String, doubleList: ArrayList<Double?>) {
        checkForNullKey(key)
        val myDoubleList = doubleList.toTypedArray<Double?>()
